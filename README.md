...
conditionally-supported                 有条件支持的
conflict                                冲突
conjunction                             合取
...
fraction                                小数，分数
free store                              自由存储
freestanding implementation             自立式实现
friend                                  友元
...
template non-type parameter             模板非类型形参
template template parameter             模板模板形参
